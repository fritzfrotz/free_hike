...
| 8 | Background schedulers (BGProcessingTask / WorkManager FGS) + thermal governance | ⏳ **IN PROGRESS** — P8.C1 closed: FFI `ThermalState` + atomic governance core (`SliceGovernor` slice throttling, capped rayon pool with wave admission); remaining: Swift/Kotlin schedulers + thermal observers |
