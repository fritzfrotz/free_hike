 ...
 *   syncToGoogle(gpx, meta)   → upload two files to /FreeHike/ folder
...
const GOOGLE_FOLDER_NAME  = 'FreeHike';
const GOOGLE_SCOPE        = 'https://www.googleapis.com/auth/drive.file openid email';
const GOOGLE_TOKEN_KEY    = 'freehike_google_token';
...
/**
 * Ensures the FreeHike folder exists in Drive and returns its file ID.
